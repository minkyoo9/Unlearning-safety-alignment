...
def load_pretrained_models(  # pylint: disable=too-many-arguments
    ...
    *,
    ...
    # if not model_name_or_path.endswith('-Instruct'):
    #     model_name_or_path = f'{model_name_or_path}-Instruct'
    ...
    # model.heads[model.active_head].config['vocab_size'] = model.config.vocab_size
