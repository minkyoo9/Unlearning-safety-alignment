...
do
    ...
    do
        ...
        --output_dir ./saves_3B/eval_tv/alpha2 --overwrite_cache \
        ...
        --output_result_dir ./results_3B/eval_tv/alpha2 \
        --bf16 --eval_dataset_dir ../../data/RWKU/Target/ \
        --target ${id} 2>&1 | tee ./logs_3B/eval_tv/alpha2_log.txt
    done
done
