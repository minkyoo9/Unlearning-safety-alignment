...
do
    ...
    do
        ...
        --output_dir ./saves_3B/dpo_full_adv/${lr} --overwrite_cache \
        ...
        --learning_rate ${lr} --num_train_epochs 3 --val_size 0.0000001 --dpo_ftx 0.0 --plot_loss \
        --output_result_dir ./results_3B/dpo_full_adv/${lr}\
        --bf16 --eval_dataset_dir ../../data/RWKU/Target/ \
        --target ${id} 2>&1 | tee ./logs_3B/dpo_full_adv/${lr}_log.txt
    done
done
