...
do
    ...
    do
        ...
        --output_dir ./saves_3B/npo_full_adv/${lr} --overwrite_cache \
        ...
        --output_result_dir ./results_3B/npo_full_adv/${lr} \
        --bf16 --eval_dataset_dir ../../data/RWKU/Target/ \
        --target ${id} 2>&1 | tee ./logs_3B/npo_full_adv/${lr}_log.txt
    done
done
