...
class RLHFArguments:
    ...
    """
    unlearn_data: str = field(
        default="../../../harmfulness/data/unlearning_data_AdvBench_3B.json",
        metadata={"help": "Data used for unlearning"},
    )
    lambda_val: int = field(
        default=1,
        metadata={"help": "lambda used for gdr/kl"},
    )
    layer_id: int = field(
        default=1,
        metadata={"help": "layer_id used for rmu"},
    )
    alpha: float = field(
        default=1.0,
        metadata={"help": "alpha used for rmu"},
    )
    steering_coeff: float = field(
        default=1.0,
        metadata={"help": "steering_coeff used for rmu"},
    )
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments, GaloreArguments, BAdamArgument):
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "dpo", "orpo", "ga", "npo", "rt", "gd", "gd_kl", "rmu"] = field(
        default="sft",
